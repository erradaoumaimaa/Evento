<nav class="py-2.5 dark:bg-green-700" style="background-color: ; color: white;">
    <div class="flex items-center justify-between max-w-screen-xl mx-auto">
        <div class="flex items-center">

            <p class="text-2xl font-semibold"><span class="text-4xl font-semibold text-yellow-600">H</span>ireme</p>
        </div>
